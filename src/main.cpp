...
static const int64 nTargetTimespan = 10 * 60; // DorianCoin: 10 min
static const int64 nTargetSpacing = 60; // DorianCoin: 1 minute blocks
...
{
        static const int64 BlocksTargetSpacing = 60; // 160 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
        ...
        if (fTestNet) {
                ...
                if (pindexLast->nHeight+1 >= 500) { DiffMode = 2; }//starts on block no. 500
        }
